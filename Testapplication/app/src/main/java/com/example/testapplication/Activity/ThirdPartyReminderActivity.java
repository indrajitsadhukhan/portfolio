...
import com.example.testapplication.Adapters.ReminderAdapter;
...
public class ThirdPartyReminderActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderAdapter =new ReminderAdapter(array);
        recyclerreminder.setAdapter(reminderAdapter);
    }
    @OnClick(R.id.submitreminder)
    public void onViewClicked() {
        int type= reminderAdapter.getCheck();
