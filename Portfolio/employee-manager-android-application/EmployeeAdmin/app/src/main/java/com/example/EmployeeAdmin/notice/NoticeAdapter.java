package com.example.EmployeeAdmin.notice;
...
final NoticeData currItem=list.get(position);
holder.deleteNoticeTitle.setText(currItem.getTitle());
        try {
            if(currItem.getImage()!=null)
            Picasso.get().load(currItem.getImage()).into(holder.deleteNoticeImage);
        } catch (Exception e) {
            e.printStackTrace();
        }
                ...
                builder.setPositiveButton("Ok",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                reference.child(currItem.getKey()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
